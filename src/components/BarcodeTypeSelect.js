...
const BarcodeTypeSelect = () => {
  ...
  // Will dynamically pull from the API and store locally in the future
  const barcodeTypes = [
  ...
  return (
    <div>
      ...
      <Select value={barcodeType} onValueChange={(value) => dispatch(setBarcodeType(value))} disabled={isLimitExceeded}>
